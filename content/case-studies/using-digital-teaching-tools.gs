...
Having used Seneca Learning as a revision resource with some learners in previous years, we decided to set a personalised daily assignment on this platform in each of the core subjects. These could be accessed at any time by the learner (although a daily timetable was developed and encouraged), and from which they would receive immediate feedback. 
