...
As you adjust to new responsibilities and adapt to new circumstances, devote some time to helping your children continue a basic level of learning. Activities such as reading to or with your children will help their development. You should also:

* not feel like you need to become a teacher
* create a regular daily routine for your children
* devote some one-on-one time with each child, where you have more than one
* help children to set learning goals

### Supporting children's wellbeing

You may notice children showing signs of anxiety related to coronavirus or the changes to their usual routine.

Guidance is available from UNICEF on how parents and carers can provide reassurance and support to children. In general, try to:

* give clear answers that your children can understand if they ask you questions about coronavirus (the latest information is available at gov.uk/coronavirus)
...
Pupils will in many cases need to use a digital device such as a computer or tablet to complete work sent to them electronically. There are a range of activities to develop pupils' reading and writing skills that don't involve screen time. Parents can, for example:
...
* encourage children of all ages to write by hand, by making lists or filling out learning journals, for example
* set up appropriate parental control functions on digital devices that pupils are using, so they remain focussed on their studies

When accessing resources provided by the school or other online learning providers, always monitor who your children are communicating with online to ensure their safety. Further information can be found at:

* [Thinkuknow](http://www.thinkuknow.co.uk/) - Advice from the National Crime Agency to stay safe online
* [Internet Matters](https://www.internetmatters.org/) - Support for parents and carers to keep their children safe online
* [Parent Info](https://parentinfo.org/) - Support for parents and carers to keep their children safe online
* [LGfL](http://www.lgfl.net/online-safety/) - Support for parents and carers to keep their children safe online
* [Net Aware](https://www.net-aware.org.uk/) - Support for parents and carers from the NSPCC
